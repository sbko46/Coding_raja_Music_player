const cartoonAudio = new Audio('Cartoon.mp3');
const forceAudio = new Audio('force.mp3');
const squeakyAudio = new Audio('squeaky.mp3');
const hopeAudio = new Audio('hope.mp3');
const janjiAudio = new Audio('Janji.mp3');
